...
| [`@requestnetwork/thegraph-storage`](/packages/thegraph-storage)       | [![npm](https://img.shields.io/npm/v/@requestnetwork/thegraph-storage.svg)](https://www.npmjs.com/package/@requestnetwork/thegraph-storage)       | Storage of Request data on Ethereum and IPFS, indexed by TheGraph   |
