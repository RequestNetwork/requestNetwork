  ...
  describe('getRate', async () => {
    ...
    describe('only fiat rates', async () => {
      it('can get rate from EUR to USD', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '1200000000000000000', "wrong conversion");
      });

      it('can get rate from USD to EUR', async () => {
        const conversion = await conversionPathInstance.getRate.call([USD_address, EUR_address]);
        assert.equal(conversion.rate.toString(10), '833333333333333333', "wrong conversion");
      });
      ...
      it('can get rate from USD to EUR to USD', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '999999999999999999', "wrong conversion");   
      });   
    });
    ...
    describe('Ethereum rates', async () => {
      it('can get rate from USD to ETH', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '20000000000000000000000000', "wrong conversion"); 
      });   

      it('can get rate from ETH to USD', async () => {
        conversion = await conversionPathInstance.getRate.call([ETH_address, USD_address]);
        assert.equal(conversion.rate.toString(10), '50000000000', "wrong conversion");  
      });   
      ...
      it('can get rate from EUR to USD to ETH', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '24000000000000000000000000', "wrong conversion"); 
      });   
      ...
      it('can get rate from ETH to USD to EUR', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '41666666666', "wrong conversion");
      });
    });
    ...
    describe('USDT rates', async () => {
      it('can get rate from USD to ETH to USDT', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '10000000000000000', "wrong conversion");
      }); 
      ...
      it('can get rate from USDT to ETH to USD', async () => {
        ...
        assert.equal(conversion.rate.toString(10), '100000000000000000000', "wrong conversion");
      }); 
    }); 
  });
  ...
  describe('getConversion', async () => {
    ...
    describe('only fiat conversion', async () => {
      it('can convert EUR to USD', async () => {
        ...
        assert.equal(conversion.result.toString(10), '12000000000', "wrong conversion");
      });
      ...
      it('can convert USD to EUR', async () => {
        ...
        assert.equal(conversion.result.toString(10), '8333333333', "wrong conversion");
      });
    ...
    describe('Ethereum conversion', async () => {
      it('can convert USD to ETH', async () => {
        ...
        assert.equal(conversion.result.toString(10), '2000000000000000000', "wrong conversion"); 
      });   
      ...
      it('can convert ETH to USD', async () => {
        ...
        assert.equal(conversion.result.toString(10), '100000000000', "wrong conversion");
      });   
      ...
      it('can convert EUR to USD to ETH', async () => {
        ...
        assert.equal(conversion.result.toString(10), '2400000000000000000', "wrong conversion"); 
      });   
      ...
      it('can convert ETH to USD to EUR', async () => {
        ...
        assert.equal(conversion.result.toString(10), '83333333332', "wrong conversion");
      });
    });
    ...
    describe('USDT conversion', async () => {
      it('can convert USD to ETH to USDT', async () => {
        ...
        assert.equal(conversion.result.toString(10), '100000000', "wrong conversion");
      }); 
      ...
      it('can convert USDT to ETH to USD', async () => {
        ...
        assert.equal(conversion.result.toString(10), '10000000000', "wrong conversion");
      }); 
    }); 
  });
});
