...
contract ProxyChainlinkConversionPath {
    ...
    function transferFromWithReferenceAndFee(
        ...
        (uint256 amountToPay, uint256 amountToPayInFees) =
            getConversions(_path, _requestAmount, _feeAmount, _maxRateTimespan);
    ...
    function getConversions(
        ...
        (uint256 rate, uint256 oldestTimestampRate, uint256 decimals) =
