const artifactsERC20FeeProxy = require('../../artifacts/ERC20FeeProxy/artifacts.json');
const ARTIFACTS_VERSION: string = artifactsERC20FeeProxy.lastVersion;
...
export function getContractAbi(): any {
  const artifactFilename: string = artifactsERC20FeeProxy[ARTIFACTS_VERSION].artifact;
