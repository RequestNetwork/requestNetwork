...
describe('Amount utils', () => {
  ...
  it('cannot valid amount as big integer', () => {
    expect(Amount.isValid(1000000000000000000000000000000), 'Big integer should not be valid').to.be
      .false;
  });
  ...
  it('cannot valid amount as a big decimal', () => {
    expect(Amount.isValid(100000000000000000000000000000000000.001), 'decimal should not be valid')
      .to.be.false;
  });
