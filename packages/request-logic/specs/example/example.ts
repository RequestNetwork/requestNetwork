...
// create request
const actionCreation = RequestLogic.formatCreate(createParams, bobRaw.identity, signatureProvider);
// apply creation
let requestState = RequestLogic.applyActionToRequest(null, actionCreation);
console.log('###########################################');
console.log('Creation Action ---------------------------');
console.log(JSON.stringify(actionCreation));
...
console.log(JSON.stringify(actionAccept));
console.log('Request State -----------------------------');
console.log(JSON.stringify(requestState));
console.log('###########################################');
