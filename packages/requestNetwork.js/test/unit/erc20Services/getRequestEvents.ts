...
describe('erc20 getRequestEvents', () => {
    ...
    it('getRequestEvents', async () => {
        ...
        await testToken.transfer(payerRefundAddress, arbitraryAmount, {from: defaultAccount});        
        await rn.requestERC20Service.approveTokenForRequest(resultCreateRequestAsPayee.request.requestId, arbitraryAmount, {from: payerRefundAddress})

        const resultPaymentAction2 = await rn.requestERC20Service.paymentAction(
                            resultCreateRequestAsPayee.request.requestId,
                            [arbitraryAmount],
                            undefined,
