...
import rinkebyERC20AddressBasedManager from '../../../../src/extensions/payment-network/erc20/rinkeby-address-based';

import Utils from '@requestnetwork/utils';

import { expect } from 'chai';

import * as DataERC20AddPaymentAddress from '../../../utils/payment-network/erc20/rinkeby-add-payment-address-data-generator';
import * as DataERC20Create from '../../../utils/payment-network/erc20/rinkeby-create-data-generator';
import * as TestData from '../../../utils/test-data-generator';

/* tslint:disable:no-unused-expression */
describe('extensions/payment-network/erc20/rinkeby-address-based', () => {
  describe('createCreationAction', () => {
    it('can createCreationAction with payment and refund', () => {
      expect(
        rinkebyERC20AddressBasedManager.createCreationAction({
    ...
    it('can createCreationAction with nothing', () => {
      // deep copy to remove the undefined properties to comply deep.equal()
      expect(
        Utils.deepCopy(rinkebyERC20AddressBasedManager.createCreationAction({})),
        'extensionsdata is wrong',
  ...
  describe('createAddPaymentAddressAction', () => {
    it('can createAddPaymentAddressAction', () => {
      expect(
        rinkebyERC20AddressBasedManager.createAddPaymentAddressAction({
  ...
  describe('createAddRefundAddressAction', () => {
    it('can createAddRefundAddressAction', () => {
      expect(
        rinkebyERC20AddressBasedManager.createAddRefundAddressAction({
  ...
  describe('applyActionToExtension', () => {
    describe('applyActionToExtension/unknown action', () => {
      it('cannot applyActionToExtensions of unknown action', () => {
        ...
        expect(() => {
          rinkebyERC20AddressBasedManager.applyActionToExtension(
