...
describe('extensions/payment-network/erc20/fee-proxy-contract', () => {
  describe('createCreationAction', () => {
    ...
    it(
      'cannot createCreationAction with fee address not an ethereum address',
      () => {
        expect(() => {
          erc20FeeProxyContract.createCreationAction({
  ...
  describe('createAddFeeAction', () => {
    ...
    it(
      'cannot createAddFeeAddressAction with payment address not an ethereum address',
      () => {
        expect(() => {
          erc20FeeProxyContract.createAddFeeAction({
            feeAddress: 'not an ethereum address',
  ...
  describe('applyActionToExtension', () => {
    ...
    describe('applyActionToExtension/create', () => {
      ...
      it(
        'cannot applyActionToExtensions of creation on a non ERC20 request',
        () => {
  ...
  describe('applyActionToExtension/addFee', () => {
    ...
    it(
      'cannot applyActionToExtensions of addFee without a previous state',
      () => {
        expect(() => {
          erc20FeeProxyContract.applyActionToExtension(
            DataERC20FeeCreate.requestStateNoExtensions.extensions,
    ...
    it(
      'cannot applyActionToExtensions of addFee signed by someone else than the payee',
      () => {
        const previousState = Utils.deepCopy(DataERC20FeeCreate.requestStateCreatedEmpty);
        expect(() => {
          erc20FeeProxyContract.applyActionToExtension(
    ...
    it(
      'cannot applyActionToExtensions of addFee with fee data already given',
      () => {
        expect(() => {
          erc20FeeProxyContract.applyActionToExtension(
            DataERC20FeeCreate.requestFullStateCreated.extensions,
    ...
    it(
      'cannot applyActionToExtensions of addFee with fee address not valid',
      () => {
    ...
    it(
      'cannot applyActionToExtensions of addFee with fee amount not valid',
      () => {
        const testnetPaymentAddress = Utils.deepCopy(DataERC20FeeAddData.actionAddFee);
