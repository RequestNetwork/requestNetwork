...
| **values.tokensAccepted** | Array  | The list of tokens addresses accepted for payments                    | Mandatory     |
...
| **parameters.tokensAccepted** | Array  | The list of tokens addresses accepted for payments                    | Mandatory     |
...
- The `tokensAccepted` is not empty and contains only valid ethereum addresses.
...
| **values.tokensAccepted** | `tokensAccepted` from parameters                               |
