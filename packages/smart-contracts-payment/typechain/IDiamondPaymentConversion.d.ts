...
interface IDiamondPaymentConversionInterface extends ethers.utils.Interface {
  functions: {
...
export class IDiamondPaymentConversion extends BaseContract {
  ...
  interface: IDiamondPaymentConversionInterface;
