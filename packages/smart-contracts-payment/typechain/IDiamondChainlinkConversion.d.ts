...
interface IDiamondChainlinkConversionInterface extends ethers.utils.Interface {
  functions: {
...
export class IDiamondChainlinkConversion extends BaseContract {
  ...
  interface: IDiamondChainlinkConversionInterface;
