...
import Blockstream from '../../../../../src/api/payment-network/btc/providers/blockstream-info';
  ...
  describe('getAddressInfo', () => {
    it('must throw if bitcoinNetworkId is not 0 or 3', async () => {
      try {
        ...
        await blockstreamData.getAddressInfo(1, 'address', Types.EVENTS_NAMES.PAYMENT);
