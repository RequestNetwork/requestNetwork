...
import BTCAddressedBased from './btc/address-based';
...
export default {
   ...
   * @returns {Types.IPaymentNetworkManager} the module to handle the payment network
   */
   ...
   * @returns {(Types.IPaymentNetworkManager | null)} the module to handle the payment network or null if no payment network found
   */
  getPaymentNetworkFromRequest(
    advancedLogic: AdvancedLogicTypes.IAdvancedLogic,
    request: RequestLogicTypes.IRequestLogicRequest,
  ): Types.IPaymentNetworkManager | null {
