...
const config: ClientTypes.IHttpDataAccessConfig = {
  ...
  // Exponential backoff starting at 1s, doubling each time, up to a maximum of 64s and max 7 retries with an initial 3s defer delay, yielding a total of 8 calls and total timeout of 130s
