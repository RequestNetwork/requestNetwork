...
contract('RequestEthereum createRequestAsPayer',  function(accounts) {
	...
	it("new request from payer with 3 payees all paid OK with tips with payment address", async function () {
		var balancePayeeBefore = await web3.eth.getBalance(payee);
		var balancePayee2Before = await web3.eth.getBalance(payee2);
		var balancePayee3Before = await web3.eth.getBalance(payee3);
		...
		var r = await requestEthereum.createRequestAsPayer([payee, payee2, payee3], [payeeAddressPayment,payee2AddressPayment,payee3AddressPayment], [arbitraryAmount,arbitraryAmount2,arbitraryAmount3], 0, [arbitraryAmount+1,arbitraryAmount2+2,arbitraryAmount3+3], [1,2,3], "", 
													{from:payer, value:arbitraryAmount+arbitraryAmount2+arbitraryAmount3+6});
	...
	it("new request from payer with 3 payees all paid OK with tips with 2 payments addresses", async function () {
		var balancePayeeBefore = await web3.eth.getBalance(payee);
		var balancePayee2Before = await web3.eth.getBalance(payee2);
		var balancePayee3Before = await web3.eth.getBalance(payee3);
		...
		var r = await requestEthereum.createRequestAsPayer([payee, payee2, payee3], [payeeAddressPayment,0,payee3AddressPayment], [arbitraryAmount,arbitraryAmount2,arbitraryAmount3], 0, [arbitraryAmount+1,arbitraryAmount2+2,arbitraryAmount3+3], [1,2,3], "", 
													{from:payer, value:arbitraryAmount+arbitraryAmount2+arbitraryAmount3+6});
