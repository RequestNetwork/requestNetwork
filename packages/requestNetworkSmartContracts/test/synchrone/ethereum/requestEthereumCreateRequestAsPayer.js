...
contract('RequestEthereum createRequestAsPayer',  function(accounts) {
	...
	it("new request more than expectedAmount (with tips that make the new requestment under expected) OK", async function () {
		...
		assert.equal(newReq[2],arbitraryAmount+arbitraryAmount10percent,"new request wrong data : expectedAmount");
		assert.equal(newReq[3],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[4],arbitraryAmount+1,"new request wrong data : amountPaid");
	...
	it("new request more than expectedAmount (with tips but still too much) Impossible", async function () {
		...
		assert.equal(newReq[3],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[4],arbitraryAmount+2,"new request wrong data : amountPaid");
		assert.equal(newReq[5],1,"new request wrong data : state");
	});
	...
	it("new request with more tips than msg.value OK", async function () {
		...
		assert.equal(newReq[2],arbitraryAmount+arbitraryAmount10percent,"new request wrong data : expectedAmount");
		assert.equal(newReq[3],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[4],0,"new request wrong data : amountPaid");
		assert.equal(newReq[5],1,"new request wrong data : state");
	});
	...
	it("new request with tips OK", async function () {
		...
		assert.equal(newReq[2],arbitraryAmount+arbitraryAmount10percent,"new request wrong data : expectedAmount");
		assert.equal(newReq[3],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[4],arbitraryAmount,"new request wrong data : amountPaid");
		assert.equal(newReq[5],1,"new request wrong data : state");
