...
contract('RequestEthereum Pay', function(accounts) {
	...
	it("pay if Core Paused OK", async function () {
		...
		assert.equal(newReq[6],arbitraryAmount,"new request wrong data : balance");
	...
	it("pay request by otherguy just created => impossible", async function () {
		...
		await utils.expectThrow(requestEthereum.paymentAction(utils.getRequestId(requestCore.address, 2), [arbitraryAmount], [0], {value:arbitraryAmount, from:otherguy}));
	});
	...
	it("3 pay request ", async function () {
		...
		assert.equal(newReq[5],arbitraryAmount,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount3,"new request wrong data : balance");
		assert.equal(newReq[2],1,"new request wrong data : state");
		...
		assert.equal(newReq[5],arbitraryAmount,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount3+arbitraryAmount2,"new request wrong data : balance");
		assert.equal(newReq[2],1,"new request wrong data : state");
		...
		assert.equal(newReq[5],arbitraryAmount,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount3+arbitraryAmount2+arbitraryAmount,"new request wrong data : balance");
		assert.equal(newReq[2],1,"new request wrong data : state");
	...
	it("pay by payer with tips OK", async function () {
		...
		assert.equal(newReq[4],payee,"new request wrong data : payee");
		assert.equal(newReq[0],payer,"new request wrong data : payer");
		assert.equal(newReq[5],arbitraryAmount+arbitraryTips,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount,"new request wrong data : balance");		
		assert.equal(newReq[2],1,"new request wrong data : state");
	...
	it("pay with more tips than msg.value", async function () {
		var balancePayeeBefore = await web3.eth.getBalance(payee);
		var r = await (requestEthereum.paymentAction(utils.getRequestId(requestCore.address, 1), [arbitraryTips], [arbitraryAmount], {value:arbitraryTips, from:payer}));

		var newReq = await requestCore.requests.call(utils.getRequestId(requestCore.address, 1));
		// assert.equal(newReq[0],payee,"new request wrong data : creator");
		assert.equal(newReq[4],payee,"new request wrong data : payee");
		assert.equal(newReq[0],payer,"new request wrong data : payer");
		assert.equal(newReq[5],arbitraryAmount+arbitraryAmount,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryTips,"new request wrong data : balance");		
		assert.equal(newReq[2],1,"new request wrong data : state");
	...
	it("pay more than expectedAmount (without tips) Impossible", async function () {
		var balancePayeeBefore = await web3.eth.getBalance(payee);
		var r = await (requestEthereum.paymentAction(utils.getRequestId(requestCore.address, 1), [arbitraryAmount+1], [0], {value:arbitraryAmount+1, from:payer}));
		...
		assert.equal(newReq[5],arbitraryAmount,"new request wrong data : expectedAmount");
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount+1,"new request wrong data : balance");		
		assert.equal(newReq[2],1,"new request wrong data : state");
	...
	it("pay more than expectedAmount (without tips but still to much) Impossible", async function () {
		...
		var r = await (requestEthereum.paymentAction(utils.getRequestId(requestCore.address, 1), [arbitraryAmount+2], [1], {value:arbitraryAmount+2, from:payer}));
		...
		assert.equal(newReq[1],requestEthereum.address,"new request wrong data : currencyContract");
		assert.equal(newReq[6],arbitraryAmount+2,"new request wrong data : balance");		
		assert.equal(newReq[2],1,"new request wrong data : state");
	...
	it("pay more than expectedAmount (with tips that make the payment under expected) OK", async function () {
		var balancePayeeBefore = await web3.eth.getBalance(payee);
		var r = await requestEthereum.paymentAction(utils.getRequestId(requestCore.address, 1), [arbitraryAmount+1], [arbitraryTips], {value:arbitraryAmount+1, from:payer});
		assert.equal(r.receipt.logs.length,2,"Wrong number of events");
