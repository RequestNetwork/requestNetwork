...
const erc20ContractAddress = '0x75c35C980C0d37ef46DF04d31A140b65503c0eEd';
  ...
  describe('Test sanity checks:', () => {
    ...
    it('Should consider override parameters', async () => {
      ...
      expect(spy).toHaveBeenCalledWith({
        data: `${values.paymentReference}000000000000000000000000000000000000000000000000`,
        to: escrowAddress,
        value: 0,
      });
  ...
  describe('Test encoded function data:', () => {
    ...
    it('Should encode data to execute payEscrow().', () => {
      expect(Escrow.encodePayEscrow(validRequest, wallet)).toBe(
        `${values.paymentReference}000000000000000000000000000000000000000000000000`,
      );
    });
