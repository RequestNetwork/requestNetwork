...
var RequestSynchroneExtensionEscrowService = /** @class */ (function () {
    function RequestSynchroneExtensionEscrowService(web3Provider) {
        ...
        this.releaseToPayeeAsync = function (_requestId, _numberOfConfirmation, _from, _gasPrice, _gasLimit) {
        ...
        this.releaseToPayee = function (_requestId, _callbackTransactionHash, _callbackTransactionReceipt, _callbackTransactionConfirmation, _callbackTransactionError, _from, _gasPrice, _gasLimit) {
            if (_from === void 0) { _from = undefined; }
            if (_gasPrice === void 0) { _gasPrice = undefined; }
            if (_gasLimit === void 0) { _gasLimit = undefined; }
        ...
        this.refundToPayerAsync = function (_requestId, _numberOfConfirmation, _from, _gasPrice, _gasLimit) {
            if (_numberOfConfirmation === void 0) { _numberOfConfirmation = 0; }
            if (_from === void 0) { _from = undefined; }
            if (_gasPrice === void 0) { _gasPrice = undefined; }
            if (_gasLimit === void 0) { _gasLimit = undefined; }
        ...
        this.refundToPayer = function (_requestId, _callbackTransactionHash, _callbackTransactionReceipt, _callbackTransactionConfirmation, _callbackTransactionError, _from, _gasPrice, _gasLimit) {
            if (_from === void 0) { _from = undefined; }
            if (_gasPrice === void 0) { _gasPrice = undefined; }
            if (_gasLimit === void 0) { _gasLimit = undefined; }
            // TODO check from == payer ?
