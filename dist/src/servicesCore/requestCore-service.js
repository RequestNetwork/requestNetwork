...
var RequestCoreService = /** @class */ (function () {
    ...
    RequestCoreService.prototype.getRequestByTransactionHash = function (_hash) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var txReceipt, tx, logs, event_1, request, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.instanceRequestCore.methods.requests(_requestId).call(function (err, data) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    var currencyContract, extension, networkName, optionFilters, eventsCoreRaw, getPastEvents, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, eventsCore, eventsExtensions, eventsCurrencyContract, e_3;
                    return __generator(this, function (_w) {
                        switch (_w.label) {
                            ...
                            case 1:
                                ...
                                eventsCoreRaw = [];
                                getPastEvents = this.instanceRequestCore.getPastEvents;
                                _b = (_a = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('Created', optionFilters)];
                            case 2:
                                eventsCoreRaw = _b.apply(_a, [_w.sent()]);
                                _d = (_c = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('Accepted', optionFilters)];
                            case 3:
                                eventsCoreRaw = _d.apply(_c, [_w.sent()]);
                                _f = (_e = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('Canceled', optionFilters)];
                            case 4:
                                eventsCoreRaw = _f.apply(_e, [_w.sent()]);
                                _h = (_g = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('UpdateBalance', optionFilters)];
                            case 5:
                                eventsCoreRaw = _h.apply(_g, [_w.sent()]);
                                _k = (_j = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('UpdateExpectedAmount', optionFilters)];
                            case 6:
                                eventsCoreRaw = _k.apply(_j, [_w.sent()]);
                                _m = (_l = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('NewPayee', optionFilters)];
                            case 7:
                                eventsCoreRaw = _m.apply(_l, [_w.sent()]);
                                _p = (_o = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('NewPayer', optionFilters)];
                            case 8:
                                eventsCoreRaw = _p.apply(_o, [_w.sent()]);
                                _r = (_q = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('NewExpectedAmount', optionFilters)];
                            case 9:
                                eventsCoreRaw = _r.apply(_q, [_w.sent()]);
                                _t = (_s = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('NewExtension', optionFilters)];
                            case 10:
                                eventsCoreRaw = _t.apply(_s, [_w.sent()]);
                                _v = (_u = eventsCoreRaw).concat;
                                return [4 /*yield*/, getPastEvents('NewData', optionFilters)];
                            case 11:
    ...
    RequestCoreService.prototype.getRequestsByAddress = function (_address, _fromBlock, _toBlock) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var networkName, eventsCorePayee, eventsCorePayer, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
