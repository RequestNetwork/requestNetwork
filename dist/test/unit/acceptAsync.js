    ...
    it('accept request with not valid requestId', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, rn.requestEthereumService.acceptAsync('0x00000000000000', { from: payer })];
                case 1:
                    result = _a.sent();
    ...
    it('accept request by payee or otherguy', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, rn.requestEthereumService.acceptAsync(requestId, { from: payee })];
                case 1:
                    result = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 3];
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.acceptAsync(requestId, { from: otherGuy })];
                case 4:
                    result = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 6];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    // accept first
                    return [4 /*yield*/, rn.requestEthereumService.acceptAsync(requestId, { from: payer })];
                case 1:
                    // accept first
                    _a.sent();
                    return [4 /*yield*/, rn.requestEthereumService.acceptAsync(requestId, { from: payer })];
